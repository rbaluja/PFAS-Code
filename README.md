...
1. ##### Pub/GIS/gis_head.R
   ...
   **Pub/GIS/cont_watershed.R**
    ...
    * **Pub/GIS/test_wells_watershed.R**
    ...
    * **PFAS-Code/Pub/GIS/wells_watershed.R**
    * Input: Flow accumulation raster (Data_Verify/GIS/flow_acc.tiff), flow direction raster (Data_Verify/GIS/flow_dir.tiff), wells (taken fromPub/Data/NHDES_PWS.R)
...
#### 2.Pub/Bootstrap/bootstrap_iv.R  
...
1. **Pub/Data/data_head.R**
    * **Pub/Data/pfas_lab_sites.R**
...
2. **Pub/Main Analysis/main_analy.R** 
    * **Pub/Main Analysis/binary.R**
    ...
    * **Pub/Main Analysis/flow_accumulation.R**
    ...
    * **Pub/Main Analysis/first_stage.R**
...
3. **Pub/Tables/tables.R**
   * This file needs the bootstrapped standard errors to have been calculated to run, as well as the robustness checks (drop_states, relaxed_up in main_analy.R andPub/Robustness/resid_side_comparison.R). It writes to file each of the tables used in the main text. The following files are ran within this file:
   * PFAS-Code/Pub/Robustness/oster_selection.R

4. **Pub/Figures/figures_head.R**
...
#### National Costs
**Pub/national_costs_head.R**
- nat_run_cont_ws: Recreate national watershed files?
- nat_reassn: Reassign CBG's to national release sites?
- nat_redo_soil: Recalculate soil statistics for national data?

 * **Pub/National Costs/nat_births.R**
 ...
 * **Pub/National Costs/nat_watersheds.R**
...
- **PFAS-Code/Pub/Revision2/head_ex_r2.R**
