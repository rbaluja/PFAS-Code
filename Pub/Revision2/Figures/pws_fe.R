...
np = fixest::feols(I(gestation < 37) ~  updown + down +  I(pfas/10^3) + dist  + n_sites + 
                   ...
                   |county + sys_id + year^month + birth_race_dsc_1, data = df_est, warn = F, notes = F, cluster = c("site", "year^month"))


data_pre = data.frame(
  Category = c("Baseline", "Controls"),
  Check = c("Baseline", "PWS Fixed Effects"),
...
data_pre$Check = factor(data_pre$Check, c("Baseline", "PWS Fixed Effects"))
...
pre_any = figure2_fun_pws(data_pre, "Any", FALSE, TRUE, "Any", TRUE)
...
data_mpre$Check = factor(data_mpre$Check, c("Baseline", "PWS Fixed Effects"))
...
mpre = figure2_fun_pws(data_mpre, "Moderately", FALSE, FALSE, "Moderately", TRUE)
...
data_vpre$Check = factor(data_vpre$Check, c("Baseline", "PWS Fixed Effects"))
...
vpre = figure2_fun_pws(data_vpre, "Very", FALSE, FALSE, "Very", TRUE)
...
data_epre$Check = factor(data_epre$Check, c("Baseline", "PWS Fixed Effects"))
...
epre = figure2_fun_pws(data_epre, "Extremely", TRUE, FALSE, "Extremely", TRUE)
...
data_lbw$Check = factor(data_lbw$Check, c("Baseline", "PWS Fixed Effects"))
...
lbw_any = figure2_fun_pws(data_lbw, "Any", FALSE, TRUE, "Any", FALSE)
...
data_mlbw$Check = factor(data_mlbw$Check, c("Baseline", "PWS Fixed Effects"))
...
mlbw = figure2_fun_pws(data_mlbw, "Moderately", FALSE, FALSE, "Moderately", FALSE)
...
data_vlbw$Check = factor(data_vlbw$Check, c("Baseline", "PWS Fixed Effects"))
...
vlbw = figure2_fun_pws(data_vlbw, "Very", FALSE, FALSE, "Very", FALSE)
...
data_elbw$Check = factor(data_elbw$Check, c("Baseline", "PWS Fixed Effects"))
...
elbw = figure2_fun_pws(data_elbw, "Extremely", TRUE, FALSE, "Extremely", FALSE)
...
ggsave("Figures Revision/figure2_pwsfe.png", fig2, width = 16000, height = 5500, units = "px", limitsize = F)
...
data_mort$Check = factor(data_mort$Check, c("Baseline", "PWS Fixed Effects"))
