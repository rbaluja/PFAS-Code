...
source("PFAS-Code/Pub/Revision2/Surface Water/Data/pfas_lab_sites.R")

#well location and service area data (NHDES)
source("PFAS-Code/Pub/Revision2/Surface Water/Data/NHDES_PWS.R")

#set up wind
source("PFAS-Code/Pub/Revision2/Surface Water/Data/wind.R")
...
if (code_check == TRUE){
  ...
  if (run_cleaning == TRUE | !file.exists(paste0(natality_path, "[UA Box Health] birth_records_matched_surface_water_cv_", code_verify, ".RData"))){
    
    #read in (and clean) natality data
    source('PFAS-Code/Pub/Revision2/Surface Water/Data/natality_data.R') 
    
    #get covariates for birth records
    source("PFAS-Code/Pub/Revision2/Surface Water/Data/birth_covars.R")
    
    #match residences to water wells
    source("PFAS-Code/Pub/Revision2/Surface Water/Data/natality_wells.R")
    
    #get elevation at relevant well and residence
    source("PFAS-Code/Pub/Revision2/Surface Water/Data/elev_setup.R")
    
    save(df, file = paste0(natality_path, "[UA Box Health] birth_records_matched_surface_water_cv_", code_verify, ".RData"))
    
  }else{
    load(paste0(natality_path, "[UA Box Health] birth_records_matched_surface_water_cv_", code_verify, ".RData")) 
  } 
}
