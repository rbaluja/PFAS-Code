...
# fv_lbw = function(v){
#   val = (delta * (rmax - r2_tilde) * var_y) * (b_dot - b_tilde) * var_x + 
#     v * (delta * (rmax - r2_tilde) * var_y * (var_x - tau_x) - (r2_tilde - short_r2) * var_y * tau_x - var_x * tau_x * (b_dot - b_tilde)^2) +
#     v^2 * (tau_x * (b_dot - b_tilde) * var_x * (delta - 2)) + 
#     v^3 * (delta - 1) * (tau_x * var_x - tau_x^2)
#   return(val)
# }
