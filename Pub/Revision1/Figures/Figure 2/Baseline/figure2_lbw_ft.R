...
data = data.frame(
  ...
  Estimate = c(full$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               drop_close$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, pre_2016$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               lbw_ft_ds$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100,  lbw_ft_rup$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100,
               no_pers$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               no_med$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, site$coefficients["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100),
  StdError = c(full$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               drop_close$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, pre_2016$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               lbw_ft_ds$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               lbw_ft_rup$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100,
               no_pers$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, 
               no_med$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100, site$se["down"]/mean(df_est[df_est$gestation >= 37, ]$bweight < 2500) * 100),
...
ggsave("Figures Revision/figure2_lbw_ft.png", lbw_ft_f2, width = 12000, height = 4500, units = "px", limitsize = F)
