#robustness figure
source("PFAS-Code/Pub/Revision1/Figures/Figure 2/Baseline/figure2_upgradient_fn.R")
...
data = data.frame(
  ...
  Estimate = c(full$coefficients["updown"]/mean(df_est$gestation < 37) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$gestation < 37) * 100, pre_2016$coefficients["updown"]/mean(df_est$gestation < 37) * 100, 
               p_all_ds$coefficients["updown"]/mean(df_est$gestation < 37) * 100, 
               no_pers$coefficients["updown"]/mean(df_est$gestation < 37) * 100, 
               no_med$coefficients["updown"]/mean(df_est$gestation < 37) * 100, site$coefficients["updown"]/mean(df_est$gestation < 37) * 100),
  StdError = c(full$se["updown"]/mean(df_est$gestation < 37) * 100, 
               drop_close$se["updown"]/mean(df_est$gestation < 37) * 100, pre_2016$se["updown"]/mean(df_est$gestation < 37) * 100, 
               p_all_ds$se["updown"]/mean(df_est$gestation < 37) * 100, 
               no_pers$se["updown"]/mean(df_est$gestation < 37) * 100, 
               no_med$se["updown"]/mean(df_est$gestation < 37) * 100, site$se["updown"]/mean(df_est$gestation < 37) * 100),
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, pre_2016$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100,
               lp_ds$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100,  
               no_pers$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               no_med$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, site$coefficients["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100),
  StdError = c(full$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               drop_close$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, pre_2016$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               lp_ds$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               no_pers$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, 
               no_med$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100, site$se["updown"]/mean(df_est$gestation < 37 & df_est$gestation >= 32) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015",
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, pre_2016$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100,
               mp_ds$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               no_pers$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               no_med$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, site$coefficients["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100),
  StdError = c(full$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               drop_close$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, pre_2016$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100,
               mp_ds$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               no_pers$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, 
               no_med$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100, site$se["updown"]/mean(df_est$gestation < 32 & df_est$gestation >= 28) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$gestation < 28) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$gestation < 28) * 100, pre_2016$coefficients["updown"]/mean(df_est$gestation < 28) * 100, 
               vp_ds$coefficients["updown"]/mean(df_est$gestation < 28) * 100, no_pers$coefficients["updown"]/mean(df_est$gestation < 28) * 100, 
               no_med$coefficients["updown"]/mean(df_est$gestation < 28) * 100, site$coefficients["updown"]/mean(df_est$gestation < 28) * 100),
  StdError = c(full$se["updown"]/mean(df_est$gestation < 28) * 100, 
               drop_close$se["updown"]/mean(df_est$gestation < 28) * 100, pre_2016$se["updown"]/mean(df_est$gestation < 28) * 100, 
               vp_ds$se["updown"]/mean(df_est$gestation < 28) * 100, 
               no_pers$se["updown"]/mean(df_est$gestation < 28) * 100, 
               no_med$se["updown"]/mean(df_est$gestation < 28) * 100, site$se["updown"]/mean(df_est$gestation < 28) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$bweight < 2500) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$bweight < 2500) * 100, pre_2016$coefficients["updown"]/mean(df_est$bweight < 2500) * 100, 
               lbw_all_ds$coefficients["updown"]/mean(df_est$bweight < 2500) * 100,  
               no_pers$coefficients["updown"]/mean(df_est$bweight < 2500) * 100, 
               no_med$coefficients["updown"]/mean(df_est$bweight < 2500) * 100, site$coefficients["updown"]/mean(df_est$bweight < 2500) * 100),
  StdError = c(full$se["updown"]/mean(df_est$bweight < 2500) * 100, 
               drop_close$se["updown"]/mean(df_est$bweight < 2500) * 100, pre_2016$se["updown"]/mean(df_est$bweight < 2500) * 100, 
               lbw_all_ds$se["updown"]/mean(df_est$bweight < 2500) * 100, 
               no_pers$se["updown"]/mean(df_est$bweight < 2500) * 100, 
               no_med$se["updown"]/mean(df_est$bweight < 2500) * 100, site$se["updown"]/mean(df_est$bweight < 2500) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, pre_2016$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100,
               llbw_ds$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               no_pers$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               no_med$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, site$coefficients["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100),
  StdError = c(full$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               drop_close$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, pre_2016$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               llbw_ds$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               no_pers$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, 
               no_med$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100, site$se["updown"]/mean(df_est$bweight < 2500 & df_est$bweight >= 1500) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, pre_2016$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               mlbw_ds$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100,  
               no_pers$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               no_med$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, site$coefficients["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100),
  StdError = c(full$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               drop_close$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, pre_2016$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100,
               mlbw_ds$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               no_pers$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, 
               no_med$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100, site$se["updown"]/mean(df_est$bweight < 1500 & df_est$bweight >= 1000) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
data = data.frame(
  ...
  Check = c("Baseline", "Drop within 1km", "Drop After 2015", 
            "Drop Border Sites",
            "No Demographics", "No Medical Controls", "Site Fixed Effects"),
  Estimate = c(full$coefficients["updown"]/mean(df_est$bweight < 1000) * 100, 
               drop_close$coefficients["updown"]/mean(df_est$bweight < 1000) * 100, pre_2016$coefficients["updown"]/mean(df_est$bweight < 1000) * 100, 
               vlbw_ds$coefficients["updown"]/mean(df_est$bweight < 1000) * 100,  
               no_pers$coefficients["updown"]/mean(df_est$bweight < 1000) * 100, 
               no_med$coefficients["updown"]/mean(df_est$bweight < 1000) * 100, site$coefficients["updown"]/mean(df_est$bweight < 1000) * 100),
  StdError = c(full$se["updown"]/mean(df_est$bweight < 1000) * 100, 
               drop_close$se["updown"]/mean(df_est$bweight < 1000) * 100, pre_2016$se["updown"]/mean(df_est$bweight < 1000) * 100, 
               vlbw_ds$se["updown"]/mean(df_est$bweight < 1000) * 100, 
               no_pers$se["updown"]/mean(df_est$bweight < 1000) * 100, 
               no_med$se["updown"]/mean(df_est$bweight < 1000) * 100, site$se["updown"]/mean(df_est$bweight < 1000) * 100),
  pval = c(one_sp_up(full$coeftable["updown", "t value"], full$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(drop_close$coeftable["updown", "t value"], drop_close$coeftable["updown", "Pr(>|t|)"]), 
           one_sp_up(pre_2016$coeftable["updown", "t value"], pre_2016$coeftable["updown", "Pr(>|t|)"]), 
...
ggsave("Figures Revision/figure2_upgradient.png", fig2_up, width = 17000, height = 10000, units = "px", limitsize = F)