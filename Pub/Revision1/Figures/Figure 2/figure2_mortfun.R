figure2_still_fun = function(data, category, keep_x, header, ti, left){
  ...
  if (keep_x){
    ...
    pany1 = data %>% 
      ...
      guides(color = "none") + xlim(c(-0.05, 0.1))
  }
...
figure2_still_fun_count = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
  ...
  if (keep_x){
    ...
    pany1 = data %>% 
      ...
      theme(axis.line = element_blank(),
            ...
            axis.text= element_blank(),
            axis.title= element_blank()) + 
      guides(color = "none") + xlim(c(-2500, 10000))
  }
...
figure2_still_fun_logit = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
