figure2_still_fun_np = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    ...
    col = "orchid4"
  }else if (category == "Infant Mortality"){
    col = "firebrick"
  }
...
figure2_still_fun_npease = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
...
figure2_still_fun_cws = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
...
figure2_still_fun_ivbin = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
  ...
  if (header){
    ...
    res_plot$Check = factor(res_plot$Check, c("Model 1", "Model 2", "Model"
    ))
    res_plot$model = res_plot$Check
  }else{
    res_plot$Check = factor(res_plot$Check, c("Model 1", "Model 2",
    ))
    res_plot$model = res_plot$Check
  }
...
figure2_still_fun_ivthresh = function(data, category, keep_x, header, ti, left){
  if (category == "Any" | category == "Any Low-Birthweight (Full-Term)"){
    col = "dodgerblue"
  }else if (category == "Slightly" | category == "Slightly"){
    col = "coral"
  ...
  if (header){
    ...
    res_plot$Check = factor(res_plot$Check, c("500 ppt", "1000 ppt"))
    res_plot$model = res_plot$Check
  }
