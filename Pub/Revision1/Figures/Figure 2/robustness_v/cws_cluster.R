...
np = fixest::feols(I(gestation < 37) ~  updown + down +  I(pfas/10^3) + dist  + n_sites + 
                   ...
                   |county + year^month + birth_race_dsc_1, data = df_est, warn = F, notes = F, cluster = c("sys_id", "year^month"))
...
pre_any = figure2_fun_cws(data_pre, "Any", FALSE, TRUE, "Any", TRUE)
...
mpre = figure2_fun_cws(data_mpre, "Moderately", FALSE, FALSE, "Moderately", TRUE)
...
vpre = figure2_fun_cws(data_vpre, "Very", FALSE, FALSE, "Very", TRUE)
...
epre = figure2_fun_cws(data_epre, "Extremely", TRUE, FALSE, "Extremely", TRUE)
...
lbw_any = figure2_fun_cws(data_lbw, "Any", FALSE, TRUE, "Any", FALSE)
...
mlbw = figure2_fun_cws(data_mlbw, "Moderately", FALSE, FALSE, "Moderately", FALSE)
...
vlbw = figure2_fun_cws(data_vlbw, "Very", FALSE, FALSE, "Very", FALSE)
...
elbw = figure2_fun_cws(data_elbw, "Extremely", TRUE, FALSE, "Extremely", FALSE)
...
ggsave("Figures Revision/figure2_cws.png", fig2, width = 17000, height = 5500, units = "px", limitsize = F)
...
mort_f2 = figure2_still_fun_cws(data_mort, "Infant Mortality", TRUE, TRUE, "Infant Mortality", FALSE)
mort_f2 = mort_f2 + ggtitle("Infant Mortality") + theme_void() + theme(plot.title = element_text(hjust = -1.5, size = 70, face = "bold"))
ggsave("Figures Revision/figure2_mort_cws.png", mort_f2, width = 11000, height = 2000, units = "px", limitsize = F)
