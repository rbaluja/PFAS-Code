...
df_est_np = df[which(!is.na(df$dist) & df$dist <= 5000), ]
df_est_np = df_est %>% 
...
data_pre = data.frame(
  ...
  Check = c("Baseline", "W/O Paternal Education"),
...
data_pre$Check = factor(data_pre$Check, c("Baseline", "W/O Paternal Education"))
...
pre_any = figure2_fun_np(data_pre, "Any", FALSE, TRUE, "Any", TRUE)
...
data_mpre$Check = factor(data_mpre$Check, c("Baseline", "W/O Paternal Education"))
...
mpre = figure2_fun_np(data_mpre, "Moderately", FALSE, FALSE, "Moderately", TRUE)
...
data_vpre$Check = factor(data_vpre$Check, c("Baseline", "W/O Paternal Education"))
...
vpre = figure2_fun_np(data_vpre, "Very", FALSE, FALSE, "Very", TRUE)
...
data_epre$Check = factor(data_epre$Check, c("Baseline", "W/O Paternal Education"))
...
epre = figure2_fun_np(data_epre, "Extremely", TRUE, FALSE, "Extremely", TRUE)
...
data_lbw$Check = factor(data_lbw$Check, c("Baseline", "W/O Paternal Education"))
...
lbw_any = figure2_fun_np(data_lbw, "Any", FALSE, TRUE, "Any", FALSE)
...
data_mlbw$Check = factor(data_mlbw$Check, c("Baseline", "W/O Paternal Education"))
...
mlbw = figure2_fun_np(data_mlbw, "Moderately", FALSE, FALSE, "Moderately", FALSE)
...
data_vlbw$Check = factor(data_vlbw$Check, c("Baseline", "W/O Paternal Education"))
...
vlbw = figure2_fun_np(data_vlbw, "Very", FALSE, FALSE, "Very", FALSE)
...
data_elbw$Check = factor(data_elbw$Check, c("Baseline", "W/O Paternal Education"))
...
elbw = figure2_fun_np(data_elbw, "Extremely", TRUE, FALSE, "Extremely", FALSE)
...
ggsave("Figures Revision/figure2_nopeduc.png", fig2, width = 16000, height = 5500, units = "px", limitsize = F)
...
data_mort$Check = factor(data_mort$Check, c("Baseline", "W/O Paternal Education"))
...
mort_f2 = figure2_still_fun_np(data_mort, "Infant Mortality", TRUE, TRUE, "Infant Mortality", FALSE)
mort_f2 = mort_f2 + ggtitle("Infant Mortality") + theme_void() + theme(plot.title = element_text(hjust = -1.5, size = 70, face = "bold"))
ggsave("Figures Revision/figure2_mort_nopeduc.png", mort_f2, width = 11000, height = 2000, units = "px", limitsize = F)
