...
vpre_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0047 # 92.33542
vpre_cost = (vpre_births * vpre_pc)/10^9
#standard error: 
vpre_births_se =sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0018 #35.3625
vpre_cost_se = (vpre_births_se * vpre_pc)/10^9

mpre_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0025 #49.11458
mpre_cost = (mpre_births * mpre_pc)/10^9
#standard error: 
mpre_births_se =sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0027 #53.04375
mpre_cost_se = (mpre_births_se *  mpre_pc)/10^9

lpre_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0076 # 149.3083
lpre_cost = (lpre_births * lpre_pc)/10^9
#standard error: 
lpre_births_se =sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0079 #155.2021
lpre_cost_se = (lpre_births_se * lpre_pc)/10^9


#birthweight
vlbw_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0061 #119.8396
vlbw_cost = (vlbw_births * vlbw_pc)/10^9
#standard error: 
vlbw_births_se =sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0021 #41.25625
vlbw_cost_se = (vlbw_births_se * vlbw_pc)/10^9

mlbw_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * -0.00005 #-0.9822917
mlbw_cost = (mlbw_births * mlbw_pc)/10^9
#standard error: 
mlbw_births_se =sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.00185 #36.34479
mlbw_cost_se = (mlbw_births_se * mlbw_pc)/10^9

lbw_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0204
lbw_births_se = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0086

#infant mortality
mort_births = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0061
mort_cost = (mort_births * mort_pc)/10^9
mort_births_se = sum(births[which(births$state11 == 1), ]$births_pfas, na.rm = T) * 0.0018
...
figure_s7 = (mort_cost_fig | p_costs | lbw_cost) + plot_layout(widths = c(1, 3, 3), guides = "collect")& 
  theme(legend.position = 'bottom')
ggsave("Figures Revision/bin_cost_xgboost11.png", figure_s7, width = 10416, height = 11291, units = "px", device = "png")