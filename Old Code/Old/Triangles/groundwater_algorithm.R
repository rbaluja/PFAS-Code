#read in functions
source(paste0('Code/', t_option, '/triangle_functions.R'))
...
################
sf_use_s2(TRUE)
huc8_shape = st_read(paste0('Data/Groundwater/WBD_01_HU2_Shape/Shape/WBDHU', huc, '.shp')) %>% 
  st_transform(4326)
...
if (rerun_gw == T){
  ...
  if (ppt != 1000){
    ...
    load("~/Desktop/PFAS Infants/New Hampshire/Data/RData/ols_list_huc10_1000ppt.RData")
  }
