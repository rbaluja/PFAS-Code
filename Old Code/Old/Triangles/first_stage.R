...
fs_reg = fixest::feols(as.formula(paste("asinh(pfoa)", "~",
                                        paste(paste0("asinh(", colnames(c)[endsWith(colnames(c), "pfas")], ")", sep = ""), collapse = " + "), 
...
pfas_plot = figure_fun(fs_reg, "pfas)", meters, 
                       n_triangles, c(2, 4, 6, 8), color = "YlOrRd", 
                       title = "First Stage PFOA") 
