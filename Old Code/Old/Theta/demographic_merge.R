...
dem = fread("Data/Supplemental/tract_stats.csv", colClasses = c("tract" = "character"))
dem = dem %>% 
...
fwrite(d, "Data/Supplemental/dems.csv")
...
save(df, file = "/Users/nhdata/Library/CloudStorage/Box-Box/[UA Box Health] Economics/[UA Box Health] natality_wdemsurface.RData")
