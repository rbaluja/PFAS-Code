...
#fill sinks
wbt_breach_depressions(modify_path("Data_Verify/GIS/dem_smoothed.tiff"), modify_path("Data_Verify/GIS/filled_dem_smoothed.tiff"))

#flow accumulation
wbt_d8_flow_accumulation(modify_path("Data_Verify/GIS/filled_dem_smoothed.tiff"), modify_path("Data_Verify/GIS/flow_acc_smoothed.tiff"))

#flow direction
wbt_d8_pointer(modify_path("Data_Verify/GIS/filled_dem_smoothed.tiff"), modify_path("Data_Verify/GIS/flow_dir_smoothed.tiff"))
...
f1_watershed = function(i){
  ...
  wbt_snap_pour_points(pour_pts = temp_point_path, 
                       flow_accum = modify_path("Data_Verify/GIS/flow_acc_smoothed.tiff"), 
                       output = modify_path(paste0("Data_Verify/GIS/figure1/cont_pp/pp_site_", i, ".shp")), 
                       snap_dist = 0.007569 * 5)
  #calculate watershed
  wbt_watershed(d8_pntr = modify_path("Data_Verify/GIS/flow_dir_smoothed.tiff"), 
